<?php
  ...
  $officePrdcts = [];
  $result = $mysql->query('SELECT * from allproducts WHERE type = "office"');
...
<body>
  ...
  <div class="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="office.php">Канцелярия</a>
              </li>
              <li class="nav-item">
    ...
    <main class="main">
        <h2 class="title-site" style="font-weight: 600; font-size: 32px; margin-bottom: 1%; font-family: 'gilroy-Regular', sans-serif;">Канцелярия</h2>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="width: 90%;">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/office-slide1.webp" class="d-block w-100" alt="Первый слайд">
          </div>
          <div class="carousel-item">
            <img src="img/office-slide2.webp" class="d-block w-100" alt="Второй слайд">
          </div>
          <div class="carousel-item">
            <img src="img/office-slide3.webp" class="d-block w-100" alt="Третий слайд">
          </div>
        </div>
          ...
          <div class="modal-content">
            <div class="basket-card">
                ...
                <?php if (isset($_SESSION['cart'])): ?>
                  <?php foreach($_SESSION['cart'] as $key): ?>
                    ...
                    <div class='basket-item'>
                      ...
                      <a href="deleteCard.php?id=<?=$key['id'];?>&from=office"><div class="minus">-</div></a>
                      <span class='numInBask'><strong><?= $call = $key['count'];?></strong></span>
                      <a href="addToCard.php?id=<?=$key['id'];?>&from=office"><div class="plus">+</div></a>
              ...
              <form class="basket-btn-container" method="post" action="addToOrders.php">
                <a href="deleteCard.php?from=office" class="btns">Очистить</a>
      ...
      <div class="cards">
        ...
        <?php foreach ($officePrdcts as $key): ?>
        ...
        <div class="card">
          ...
          <a href = "addToCard.php?img=<?=$key['img'];?>&id=<?=$key['id'];?>&name=<?=$key['name'];?>&price=<?=$key['price'];?>&from=office" class="btn btn-buy">Купить</a>
        </div>
        <?php endforeach; ?>
